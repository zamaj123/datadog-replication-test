...
- [x] Threshold/change/log-count/missing-data scope aligned to `INTERFACES.md` — see docs/alerts-design.md §4
...
- REST API: `/api/v1/alerts/monitors` and `/api/v1/alerts/incidents` — see `INTERFACES.md` §8.4 and docs/alerts-design.md §9
...
- Retention constraint: monitor evaluation windows must not exceed 30 days — see `INTERFACES.md` §9 and docs/alerts-design.md §4.3
